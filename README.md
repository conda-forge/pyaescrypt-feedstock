...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyaescrypt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10391&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyaescrypt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyaescrypt` can be installed with:

```
conda install pyaescrypt
```

It is possible to list all of the versions of `pyaescrypt` available on your platform with:
